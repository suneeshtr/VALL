...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public void initActionBar() {
        if (loginedUser != null) {
            ...
            ImageView numberOfListAB = (ImageView) mCustomView.findViewById(R.id.numberOfListAB);
            ...
            numberOfListAB.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    dialog.setTitle(R.string.logged_in_as);
                    dialog.setMessage(DataHolder.getUserNameByID(loginedUser.getId()));
                    dialog.show();
                    return true;
                }
            });
    ...
    public void initActionBarWithTimer() {
        if (loginedUser != null) {
            ...
            loginAsABWithTimer.setText(" Calling..");
